package com.sabadell.bs_banking;

import android.app.Activity;
import android.content.Context;
import android.support.annotation.CheckResult;
import com.jakewharton.retrofit2.adapter.rxjava2.RxJava2CallAdapterFactory;
import com.sabadell.bs_banking.internal.data.BsBankingRepository;
import com.sabadell.bs_banking.internal.data.Ignore;
import com.sabadell.bs_banking.internal.data.Persistence;
...
public interface BsBanking {
  ...
  class Builder {
    ...
    public BsBanking build(Context context) {
      String url = dev ? BsBankingApi.URL_BASE_DEV : BsBankingApi.URL_BASE;
      ...
      return new BsBankingRepository(new Persistence(context), new Retrofit.Builder()
          .baseUrl(url)
          .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
          .addConverterFactory(GsonConverterFactory.create())
          .client(okHttpClient)
          .build().create(BsBankingApi.class), url);
    }
  }
}
